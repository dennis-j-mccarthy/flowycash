                ...
                return (
                  ...
                  >
                    ...
                    <div onClick={(e) => { e.stopPropagation(); setResetDt(key); setResetAmt(""); openPanel("reset"); }}
                      ...
                      {dd && (() => { const bethTxs = dd.transactions.filter((t) => t.name.toLowerCase().includes("beth")); if (!bethTxs.length) return null; const bethNet = bethTxs.reduce((s, t) => s + (t.type === "income" ? 1 : -1) * Math.abs(t.amount), 0); const starColor = bethNet >= 0 ? C.greenDark : C.redDark; return <svg width="14" height="14" viewBox="0 0 24 24" fill={starColor} stroke={starColor} strokeWidth="1" style={{ flexShrink: 0 }}><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>; })()}
